...
style.configure('TEntry', fieldbackground=theme_inputcolor, foreground='#070739', highlightthickness=0)
style.configure(
...
vleapp_logo_label.grid(row=0, column=0, sticky='w')
...
log_text = tk.Text(
    logtext_frame, name='log_text', bg=theme_inputcolor, fg='#070739', 
