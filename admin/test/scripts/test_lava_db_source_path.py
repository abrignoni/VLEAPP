...
An artifact whose `paths` is None searches for nothing. vleapp.py:419 hands such an
...
No VLEAPP artifact declares `paths` as None today, so that branch is code present and
unexercised here and this change alters no VLEAPP output. It is levelled from iLEAPP,
