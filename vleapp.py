...
def crunch_artifacts(search_list, extracttype, input_path, out_params, ratio, wrap_text):
    ...
    logfunc('\n--------------------------------------------------------------------------------------')
    logfunc(f'VLEAPP v{vleapp_version}: Vehicle Logs, Events, and Protobuf Parser')
    logfunc('Objective: Triage Vehicle Extractions.')
    logfunc('By: Alexis Brignoni | @AlexisBrignoni | abrignoni.com')
    logfunc('By: Geraldine Blay | @i_am_the_gia | gforce4n6.blogpost.com')
